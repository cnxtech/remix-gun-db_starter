                  ...
                  <div className="ml-10 flex items-baseline space-x-4">
                    {props.links &&
                      props.links.map((link: any) => {
                        return (
                          <div className="flex group text-gray-400 hover:text-yellow-50">
                            <Link
                              className="p-3 0"
                              key={link.label}
                              to={link.to}
                                ...
                                <span className="flex flex-col items-center">
                                  ...
                                  {link.icon ? (
                                    <SvgIcon
                                      size={'20'}
                                      path={
                                        (link.icon = paths[link.icon.item].name)
                                      }
                                      fill={
                                        !link.isSelected ? '#fff' : '#3B82F6'
                                      }
                                    />
                                  ) : (
                                    <span className="flex flex-col items-center">
              ...
              <div className="block">
                ...
                <div className="ml-4 flex items-center md:ml-6">
                  ...
                  {!props.hideGitHubLink && (
                    <a
                      href="https://github.com/bresnow/remix-gun-db_starter"
